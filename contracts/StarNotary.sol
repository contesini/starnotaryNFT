...
contract StarNotary is ERC721 {
    ...
    function buyStar(uint256 _tokenId) public  payable {
        ...
        // We can't use _addTokenTo
        // or_removeTokenFrom functions, now we have to use _transferFrom
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == ownerToken1 || msg.sender == ownerToken2, "You can only exchange stars that you own");
